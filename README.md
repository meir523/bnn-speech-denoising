...
project_report_GAMLA.pdf (or .docx): The final academic project report.

AI_usage_declaration.txt: A declaration of AI tools used for coding assistance and text refinement.
